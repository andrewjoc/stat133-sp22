...
b) Is there a row for column names?   
No, there is no row for column names.

c) Are there any missing values? If yes, how are they encoded?    
There are no missing values. According to the data dictionary `abalone.names`, missing values were removed.

d) What are the data types of each column?    
The data types are character, numeric, numeric, numeric, numeric, numeric, numeric, numeric, and integer.
...
```{r}
abalone <- read.table(
  file = "http://archive.ics.uci.edu/ml/machine-learning-databases/abalone/abalone.data",
  sep = ",", 
...
```{r}
abalone2 <- read.csv("http://archive.ics.uci.edu/ml/machine-learning-databases/abalone/abalone.data", header = FALSE, sep = ",")
...
aba4 <- read.table(
  file = "http://archive.ics.uci.edu/ml/machine-learning-databases/abalone/abalone.data",
  sep = ",", 
  col.names = c("sex", "length", "diameter", "height", "NULL", "NULL", "NULL", "NULL", "NULL"),
  colClasses = c("character", "real", "real", "real", "NULL", "NULL", "NULL", "NULL", "NULL"),
)
...
aba3 <- read.table(
  file = "http://archive.ics.uci.edu/ml/machine-learning-databases/abalone/abalone.data",
  sep = ",", 
  col.names = c("sex", "NULL", "diameter", "NULL", "whole", "NULL", "NULL", "NULL", "NULL"),
  colClasses = c("character", "NULL", "real", "NULL", "real", "NULL", "NULL", "NULL", "NULL"),
)
...
i) Use `summary()` on `abalone` to get summary statistics of the columns
