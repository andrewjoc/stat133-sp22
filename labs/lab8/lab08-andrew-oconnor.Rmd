...
```{r}
#' @title polynomial function x^2-1
#' @description returns the value of the polynomial at a specified x value
#' @param x value of x (numeric)
...
```{r}
#' @title polynomial function (x^2-1)(x+3)^3
#' @description returns the value of the polynomial at a specified x value
#' @param x value of x (numeric)
#' @return computed output 
...
```{r}
#' @title polynomial function (x^2-1)(x^2-9)
#' @description returns the value of the polynomial at a specified x value
#' @param x value of x (numeric)
#' @return computed output
...
#' @description returns the value of a circle with radius x having a default radius of 1
#' @param x radius of the circle (numeric)
...
```{r}
#' @title area of a circle
#' @description returns the value of a circle with radius x with a default radius of 1
#' @param x radius of the circle (numeric)
#' @return computed area
...
#' @description returns the area of a cylinder with varying radius and height
...
```{r}
#' @title even number
#' @description returns TRUE if the input is even, FALSE if it is odd, or NA if the input is not numeric
#' @param x input to be tested (numeric)
#' @return boolean corresponding to the description
...
```{r}
#' @title odd number
#' @description returns TRUE if the input is odd, FALSE if it is even, or NA if the input is not numeric
#' @param x input to be tested (numeric)
#' @return boolean or NA corresponding to the description
...
```{r}
#' @title squish
#' @description returns the value of a number if in the range 0 to 100. If not, it returns 0 or 100 depending on which value is closest
#' @param x input that will be squished (numeric)
#' @return value within the range 0 to 100
